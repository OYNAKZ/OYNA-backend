...
from app.api.routes import auth, branches, clubs, health, operations, owner, payments, reservations, seats, sessions, users, zones
from app.core.config import settings

api_router = APIRouter(prefix=settings.api_prefix)
api_router.include_router(auth.router, prefix="/auth", tags=["auth"])
api_router.include_router(health.router, tags=["Health"])
api_router.include_router(payments.webhook_router, prefix="/payments", tags=["payments"])
...
protected.include_router(payments.router, prefix="/payments", tags=["payments"])
